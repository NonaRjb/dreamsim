...
python scripts/generate_things_eeg_2_img_embeddings.py --data_path "$data_path" --save_path "$save_path" --model_type "$model_type" --model_name dreamsim --human_aligned
